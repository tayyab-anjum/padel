...
export const Route = createFileRoute("/community")({
  head: () => ({
    meta: [
      { title: "Community — Join the Club | Padel Hub" },
      { name: "description", content: "Leagues, tournaments, and social nights. Join the crew." },
    ],
  }),
  component: Community,
});
...
const events = [
  ...
  { icon: <Moon className="h-5 w-5" />, title: "Padel Late Nights", text: "Every Friday 10 PM–2 AM. Open courts, music, and refreshments. Just show up." },
...
function Community() {
  return (
    <>
      <PageHeader
        eyebrow="Community"
        title="Join our Padel Community."
        ...
        <div className="container-x grid items-center gap-10 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              Our padel community started as a few friends booking the same midnight slot every week.
              Now there's a regular roster, a group chat that never sleeps, and a monthly tournament with
      ...
      <section className="section-pad bg-background">
        <div className="container-x grid items-center gap-10 md:grid-cols-[3fr_2fr]">
          ...
          <div>
            ...
            >
              <Instagram className="h-4 w-4" /> @padelhub
            </a>
          </div>
        </div>
      </section>
