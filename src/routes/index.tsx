...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Padel Hub — Premier Padel Court Destination" },
      { name: "description", content: "Indoor & outdoor padel courts. Open 24 hours. Book a court, get coached by certified professionals, join our active community." },
    ],
  }),
  component: Home,
});
...
const testimonials = [
  { name: "Ahmed R.", text: "Best padel setup in town. Lights are bright, courts are quick, and the regulars make it fun.", stars: 5 },
  { name: "Sara K.", text: "Booked a coaching slot with the head coach — went from never holding a racket to playing doubles in two weeks.", stars: 5 },
    ...
    <>
        ...
        <div className="container-x flex min-h-[88vh] flex-col justify-end pb-20 pt-32 text-cream">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-sm bg-lime px-3 py-1 text-xs font-bold uppercase tracking-widest text-charcoal">
              <span className="h-1.5 w-1.5 rounded-full bg-coral" /> Now Open · Premier Courts
            </div>
            <h1 className="mt-5 text-5xl sm:text-7xl md:text-[5.5rem]">
              Your Premier <span className="text-lime">Padel</span> Destination.
            </h1>
            <p className="mt-5 max-w-xl text-base text-cream/85 sm:text-lg">
              Pro-grade courts. Floodlit nights. Coaches who'll level you up and a crew that
              actually shows up. Welcome to Padel Hub.
            </p>
      ...
      <section className="border-y border-border bg-cream">
        <div className="container-x grid divide-y divide-border md:grid-cols-3 md:divide-x md:divide-y-0">
          ...
          />
          <Stat icon={<MapPin className="h-5 w-5" />} label="Find us" value="123 Sports Club Drive" />
        </div>
      </section>
        ...
        <div className="container-x">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            ...
            <FeatureCard
              ...
              text="Group clinics, private lessons, and youth programs led by certified coaches. Beginner to advanced welcome."
              img={gear}
            />
            <FeatureCard
              icon={<Users className="h-6 w-6" />}
              title="Real community"
              text="Our active community plays here every night. Open social hours, league nights, and post-game tea."
              img={community}
            />
          </div>
        </div>
      ...
      <section className="section-pad bg-background">
        <div className="container-x grid items-center gap-10 md:grid-cols-2">
          <div>
            <div className="eyebrow">@padelhub</div>
            <h2 className="mt-2 text-4xl md:text-5xl">Catch the rallies on Instagram.</h2>
            <p className="mt-4 max-w-md text-muted-foreground">
              Follow our community online. League nights, top rallies, and coach clips drop weekly.
            </p>
            <a
            ...
            >
              <Instagram className="h-4 w-4" /> Follow @padelhub
            </a>
          </div>
