...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Padel Hub" },
      { name: "description", content: "Visit, call, or message Padel Hub. Open 24 hours." },
    ],
  }),
  component: Contact,
});
        ...
        <div className="container-x grid gap-10 lg:grid-cols-[3fr_2fr]">
          <div className="overflow-hidden rounded-md border border-border">
            <iframe
              ...
              src="https://www.google.com/maps?q=padel+courts&output=embed"
              width="100%"
              height="500"
              style={{ border: 0 }}
              loading="lazy"
          ...
          <div className="space-y-4">
            <ContactCard
              ...
              title="Address"
              body={<>123 Sports Club Drive,<br />Downtown Sports Zone</>}
            />
            <ContactCard
              icon={<Phone className="h-5 w-5" />}
              title="Phone"
              body={
                <a href="tel:+15551234567" className="font-display text-xl font-extrabold text-court">
                  +1 (555) 123-4567
                </a>
              }
              action={
                <a href="tel:+15551234567" className="btn-outline mt-3 w-full">Call now</a>
              }
            />
            <ContactCard
