...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "Pricing — Padel Hub" },
      { name: "description", content: "Court rentals, peak and off-peak rates, memberships, and group bookings." },
    ],
  }),
  component: Pricing,
});
...
const tiers = [
  ...
  },
  {
    ...
    price: "PKR 2,000",
    unit: "/ hour / court",
    points: ["Late night special", "Quiet courts", "Includes balls", "For the night owls"],
    accent: false,
  },
];
