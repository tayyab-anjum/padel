...
export const Route = createFileRoute("/booking")({
  head: () => ({
    meta: [
      { title: "Book a Court — The Padel Range" },
      { name: "description", content: "Reserve a padel court at The Padel Range, Faisalabad. Quick form or WhatsApp booking." },
    ],
  }),
  component: Booking,
});
      ...
      <section className="section-pad bg-background">
        <div className="container-x grid items-start gap-10 lg:grid-cols-[2fr_1fr]">
          ...
          <aside className="rounded-md border border-border bg-secondary p-6 md:p-8">
            ...
            <a
              href="https://wa.me/923277744474?text=Hi%20Padel%20Range%2C%20I%27d%20like%20to%20book%20a%20court."
              target="_blank"
              rel="noreferrer"
            ...
            <div className="mt-8 border-t border-border pt-6 text-sm">
              ...
              <a href="tel:+923277744474" className="mt-1 block font-display text-2xl font-extrabold text-court">
                0327 7744474
              </a>
