...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Indoor & outdoor padel courts. Open 24 hours. Coaching, community nights, easy booking." },
      { name: "author", content: "Padel Hub" },
      { property: "og:title", content: "Padel Hub — Premier Padel Court Destination" },
      { property: "og:description", content: "Pro-grade padel courts, coaching, and a community of regulars. Open 24/7." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@padelhub" },
    ],
    links: [
