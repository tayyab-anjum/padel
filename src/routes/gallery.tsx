...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      { title: "Gallery — The Padel Range Faisalabad" },
      { name: "description", content: "Court photos, action shots, and community moments from The Padel Range, Faisalabad." },
    ],
  }),
  component: Gallery,
});
...
const images = [
  ...
  { src: coach, span: "md:row-span-2", alt: "Coach Sajjad with student" },
