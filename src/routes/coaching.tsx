...
export const Route = createFileRoute("/coaching")({
  head: () => ({
    meta: [
      { title: "Padel Coaching — Padel Hub" },
      { name: "description", content: "Private and group padel coaching. Beginner to advanced. Book a session today with our certified coaches." },
    ],
  }),
  component: Coaching,
});
...
function Coaching() {
  return (
    <>
      <PageHeader
        eyebrow="Coaching"
        title="Train with our professional coaches."
        lead="Whether you've never picked up a racket or you're chasing a tournament shot, our coaching team will get you there."
      />

      <section className="section-pad bg-background">
        <div className="container-x grid items-start gap-10 md:grid-cols-[3fr_4fr]">
          <div className="overflow-hidden rounded-md border border-border">
            <img src={coach} alt="Certified Coach" className="aspect-[3/4] w-full object-cover" loading="lazy" />
          </div>
          <div>
            <div className="eyebrow">Our Training</div>
            <h2 className="mt-2 text-4xl md:text-5xl">Expert Coaches</h2>
            <p className="mt-4 text-muted-foreground">
              Our team of certified instructors has been shaping the padel scene since day one. With backgrounds in
              professional racket sports and years of on-court coaching, they have built a reputation for clear
              communication, fast progress, and a genuine love for the game.
            </p>
            <div className="mt-6 grid grid-cols-2 gap-4">
              <Stat label="Years coaching" value="10+" />
              <Stat label="Students" value="500+" />
              <Stat label="Levels taught" value="Beginner → Pro" />
              <Stat label="Certification" value="USPTA / PCR" />
            </div>
            <div className="mt-6">
