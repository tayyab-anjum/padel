    ...
    <footer className="bg-charcoal text-cream">
      <div className="container-x grid gap-10 py-16 md:grid-cols-3">
        <div>
          ...
          <p className="mt-3 max-w-xs text-sm leading-relaxed text-cream/70">
            Your home for padel. Pro-grade courts, certified coaches who'll level you up, and an active community.
          </p>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-cream/80">
            <li className="flex gap-3">
              ...
              <span>123 Sports Club Drive, Downtown</span>
            </li>
            <li className="flex gap-3">
              <Phone className="mt-0.5 h-4 w-4 shrink-0 text-lime" />
              <a href="tel:+15551234567" className="hover:text-lime">+1 (555) 123-4567</a>
            </li>
            <li className="flex gap-3">
      ...
      <div className="border-t border-cream/10">
        <div className="container-x flex flex-col items-start justify-between gap-2 py-5 text-xs text-cream/50 sm:flex-row sm:items-center">
          <p>© {new Date().getFullYear()} Padel Hub. All rights reserved.</p>
          <p>Built for the padel community.</p>
        </div>
      </div>
    </footer>
  );
