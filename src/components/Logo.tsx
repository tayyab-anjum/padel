  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      <div className="leading-[0.95]">
        <div className="font-display text-[0.7rem] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Padel</div>
        <div className="font-display text-lg font-extrabold uppercase tracking-tight text-charcoal">Hub</div>
      </div>
    </div>
  );
}
